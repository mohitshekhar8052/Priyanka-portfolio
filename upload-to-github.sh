...
if [ $? -eq 0 ]; then
    ...
    echo "   Repository: https://github.com/mohitshekhar8052/Priyanka-portfolio"
    echo ""
    echo "📝 Next steps:"
    echo "1. Go to repository Settings → Pages"
    echo "2. Enable GitHub Pages with 'main' branch"
    echo "3. Your live site will be: https://mohitshekhar8052.github.io/Priyanka-portfolio"
    echo ""
    echo "🎉 Congratulations! Your professional portfolio is now live!"
else
    echo "❌ Repository not found. Please create the repository first:"
    echo ""
    echo "1. Go to https://github.com/mohitshekhar8052"
